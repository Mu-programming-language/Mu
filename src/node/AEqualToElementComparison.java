...
public final class AEqualToElementComparison extends PElementComparison
{
    ...
    public Object clone()
    {
        return new AEqualToElementComparison(
    ...
    {
        ((Analysis) sw).caseAEqualToElementComparison(this);
    }
