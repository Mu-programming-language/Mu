...
public final class AElementExpressionSimpleExpression extends PSimpleExpression
{
    private PElementExpression _elementExpression_;

    public AElementExpressionSimpleExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AElementExpressionSimpleExpression(
    ...
    {
        ((Analysis) sw).caseAElementExpressionSimpleExpression(this);
    }
